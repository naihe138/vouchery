  ...
  return (
    <>
      <Box padding="40px">
                  ...
                  <Flex>
                    ...
                    <Box flex={1}>
                      <RadioGroup value={startValue} onChange={setStartValue}>
                        <Box>
                          <Radio value="startTime">無限制</Radio>
                        </Box>
                        <Box marginTop="20px">
                          <Radio value="setStartTime">預算限制</Radio>
                        </Box>
                      </RadioGroup>
                    </Box>
                  </Flex>
                  ...
                  <Flex>
                    ...
                    <Box flex={1}>
                      <RadioGroup value={endValue} onChange={setEndValue}>
                        <Box>
                          <Radio value="endTime">無限制</Radio>
                        </Box>
                        <Box marginTop="20px">
                          <Radio value="setEndTime">預算限制</Radio>
                        </Box>
                      </RadioGroup>
                    </Box>
                  </Flex>
            ...
            <Box>
              <Flex marginTop="30px">
                ...
                <RadioGroup value={startValue} onChange={setStartValue}>
                  <Flex>
                    <Box>
                      <Radio value="startTime">任何產品</Radio>
                    </Box>
                    <Box marginLeft={'100px'}>
                      <Box>
                        <Radio value="setStartTime">指定產品</Radio>
                        <Box marginLeft="30px">
                      ...
                      <Box marginTop="20px">
                        <Radio value="setStartTime1">不包含的產品</Radio>
                        <Box marginLeft="30px">
              ...
              <Flex marginTop="30px">
                ...
                <Box>
                  <RadioGroup value={endValue} onChange={setEndValue}>
                    <Box>
                      <Radio value="endTime">所有符合條件的產品</Radio>
                    </Box>
                    <Box marginTop="20px">
                      <Radio value="setEndTime">符合折扣的產品中價格最低者(一項產品)</Radio>
                    </Box>
                    <Box marginTop="20px">
                      <Radio value="setEndTime1">符合折扣的產品價格最高者(一項產品)</Radio>
                    </Box>
                  </RadioGroup>
                </Box>
              </Flex>
        ...
        >
          <Flex>
            <ActiveItem show={discount} setShow={() => {}} title="每人兌換次數" />
            <ActiveItem show={discountPercent} setShow={() => {}} title="最低消費" />
            <ActiveItem show={productDiscount} setShow={() => {}} title="訂單內容條件" />
            <ActiveItem show={productDiscount} setShow={() => {}} title="客戶條件" />
          </Flex>
        </Box>
        {/* 每人兌換次數 */}
        <Box>
